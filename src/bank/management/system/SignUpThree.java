...
public class SignUpThree extends JFrame implements ActionListener{
    ...
    SignUpThree(String formno){
          ...
          pnumber.setBounds(330,370,350,30);
          add(pnumber);
          ...
          c7= new JCheckBox ("I hearby decalres that the above entered deatails are correct to the best of my information");
          c7.setBackground(Color.WHITE);
          c7.setFont(new Font("Arial",Font.BOLD,16));
          c7.setBounds(100,680,720,30);
          add(c7);
